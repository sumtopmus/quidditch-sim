# MODEL: ppo_hoop_fixed_start_ppo_hoop_fixed_start_20260504_023051

**Status:** promoted  ·  **Git:** `<legacy>`
**W&B:** `wandb://ppo_hoop_fixed_start:prod` (v1, aliases: latest, prod, ppo_hoop_fixed_start, v0)
...
- **Run id:** `ppo_hoop_fixed_start_ppo_hoop_fixed_start_20260504_023051`
- **Artifact:** `ppo_hoop_fixed_start:v1`  (aliases: latest, prod, ppo_hoop_fixed_start, v0)
