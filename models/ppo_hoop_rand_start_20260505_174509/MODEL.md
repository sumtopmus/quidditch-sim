# MODEL: ppo_hoop_rand_start_ppo_hoop_rand_start_20260505_174509

**Status:** promoted  ·  **Git:** `<legacy>`
**W&B:** `wandb://ppo_hoop_rand_start:prod` (v1, aliases: latest, prod, ppo_hoop_rand_start, v0)

## Summary

drone_0 learner, init=pretrain, (parent: models/ppo_hoop_fixed_start_20260504_023051/best_model), obs SIMPLE_ENV_OBS × n_stack=1.
...
- **init mode:** `pretrain`
- **parent:** `models/ppo_hoop_fixed_start_20260504_023051/best_model`
- **parent chain total:** 30,007,296 steps
...
- **Run id:** `ppo_hoop_rand_start_ppo_hoop_rand_start_20260505_174509`
- **Artifact:** `ppo_hoop_rand_start:v1`  (aliases: latest, prod, ppo_hoop_rand_start, v0)
