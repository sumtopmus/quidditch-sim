# MODEL: ppo_hoop_rand_start_ppo_hoop_rand_start_20260430_234354

**Status:** promoted  ·  **Git:** `<legacy>`
**W&B:** `wandb://ppo_hoop_rand_start:prod` (v0, aliases: latest, prod, ppo_hoop_rand_start, v0)
...
- **Run id:** `ppo_hoop_rand_start_ppo_hoop_rand_start_20260430_234354`
- **Artifact:** `ppo_hoop_rand_start:v0`  (aliases: latest, prod, ppo_hoop_rand_start, v0)
