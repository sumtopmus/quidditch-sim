...
def write_run_info(
    ...
    *,
    ...
    Lightweight version — captures the run identity (name, trial, learner,
    opponent) and final stats.  Full pretrain ancestry is out of scope here.
    """
    ...
    # Snapshot the config that was used.
...
def build_callbacks(
    *,
    ...
    Video callback is intentionally omitted here: VideoRecorderCallback is
    coupled to QuidditchSimpleEnv-specific render plumbing.  Wire it up in
    the entry script if needed for the team env.
    """
