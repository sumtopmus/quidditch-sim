...
The canonical training framework (the SB3 path was retired in migration
Step 6). Builds a PPOConfig from Hydra, injects the instantiated reward
stack into the env_config, and hands the loop to Tune with the native
W&B logger.
"""
