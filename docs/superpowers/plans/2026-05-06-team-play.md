...
team-check-warm: ## ✅ Warm-start preserves single-agent behavior  MODEL=<run-name>
	@test -n "$(MODEL)" || { echo "ERROR: MODEL=<run-name> required"; exit 1; }; \
	 $(PYTHON) scripts/check_team_warm.py --old "models/$(MODEL)/best_model.zip"
```
